...
public class SmsAuthenticatorFactory implements AuthenticatorFactory {
	...
	public List<ProviderConfigProperty> getConfigProperties() {
		return List.of(
			...
			new ProviderConfigProperty("apitokenurl", "Access Token API URL", "The path to the Baam Token API that receives an HTTP request.", ProviderConfigProperty.STRING_TYPE, "https://example.com/api/sms/token"),
			new ProviderConfigProperty("apitokenscope", "Access Token API SCOPE", "Scope for get token from Baam.", ProviderConfigProperty.STRING_TYPE, "scope"),
			...
			new ProviderConfigProperty("priorityattribute", "Priority Atrribute", "The attribute that contains the SMS message text.", ProviderConfigProperty.STRING_TYPE, "5"),
			new ProviderConfigProperty("ttlattribute", "ttl Atrribute", "The attribute that contains the SMS message text.", ProviderConfigProperty.STRING_TYPE, "3"),
